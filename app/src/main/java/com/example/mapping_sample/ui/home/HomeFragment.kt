...
import com.example.mapping_sample.ui.home.demo.*
        ...
        binding.apply {
            composeView.setContent {
                ...
                val navigator = rememberSaveable(
                    saver = Navigator.Saver(AllDemosCategory, requireActivity().onBackPressedDispatcher, activityStarter)
                ) {
                    Navigator(AllDemosCategory, requireActivity().onBackPressedDispatcher, activityStarter)
                }
